            ...
            <div>
                <div className='links'>
                        <div className='link-img'>
                            <p>
                                <Link to='/'>
                                    ...
                                    width='150' height='36' alt='brand-image'
                                    />
                                </Link>
                            </p>
                        </div>
                        <div className='link-tag'>
                            ...
                            <p>
                                <NavLink to='/orders' end className={({ isActive }) => (isActive ? 'active' : '')}>Orders</NavLink>
                            </p>
                            <p>
                                <NavLink to='/contact' end className={({ isActive }) => (isActive ? 'active' : '')}>Contact</NavLink>
                            </p>
                        </div>
